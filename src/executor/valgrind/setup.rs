...
mod tests {
    ...
    fn test_system_info_to_codspeed_valgrind_url_ubuntu() {
        ...
        assert_snapshot!(
            ...
            @"https://github.com/CodSpeedHQ/valgrind-codspeed/releases/download/3.26.0-0codspeed5/valgrind_3.26.0-0codspeed5_ubuntu-22.04_amd64.deb"
        );
    }
    ...
    fn test_system_info_to_codspeed_valgrind_url_ubuntu_24() {
        ...
        assert_snapshot!(
            get_codspeed_valgrind_binary(&system_info).unwrap().url(),
            @"https://github.com/CodSpeedHQ/valgrind-codspeed/releases/download/3.26.0-0codspeed5/valgrind_3.26.0-0codspeed5_ubuntu-24.04_amd64.deb"
        );
    }
    ...
    fn test_system_info_to_codspeed_valgrind_url_ubuntu_arm() {
        ...
        assert_snapshot!(
            get_codspeed_valgrind_binary(&system_info).unwrap().url(),
            @"https://github.com/CodSpeedHQ/valgrind-codspeed/releases/download/3.26.0-0codspeed5/valgrind_3.26.0-0codspeed5_ubuntu-22.04_arm64.deb"
        );
    }
